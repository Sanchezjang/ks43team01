...
public class PointSaveByReview {
	...
	private String point_standard_details_code;
	...
	public String toString() {
		return "PointSaveByReview [point_review_save_standard_grade_code=" + point_review_save_standard_grade_code
				+ ", user_id_code=" + user_id_code + ", point_standard_details_code=" + point_standard_details_code
	...
	public String getPoint_standard_details_code() {
		return point_standard_details_code;
	}
	public void setPoint_standard_details_code(String point_standard_details_code) {
		this.point_standard_details_code = point_standard_details_code;
	}
